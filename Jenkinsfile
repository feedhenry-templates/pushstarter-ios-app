...
// sample values commented below are for https://github.com/feedhenry-templates/pushstarter-ios-app
/* ------------- use these to hardcode things in Jenkinsfile ---------------- */
PROJECT_NAME = "pushstarter-ios-app"
INFO_PLIST = "PushStarter/fhconfig.plist"
VERSION = "0.1-alpha"
SHORT_VERSION = "0.1"
BUNDLE_ID = "com.feedhenry.pushstarter-ios-app"
...
/*
PROJECT_NAME = params?.PROJECT_NAME?.trim()                         // e.g. "pushstarter-ios-app"
INFO_PLIST = params?.INFO_PLIST?.trim()                             // e.g. "PushStarter/fhconfig.plist"
VERSION = params?.APP_VERSION?.trim()                               // e.g. "0.1-alpha"
SHORT_VERSION = params?.APP_SHORT_VERSION?.trim()                   // e.g. "0.1"
BUNDLE_ID = params?.BUNDLE_ID?.trim()                               // e.g. "com.feedhenry.pushstarter-ios-app"
